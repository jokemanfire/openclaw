...
| `LCM_SUMMARY_BASE_URL`                    | _(from OpenClaw / provider default)_ | Base URL override for summarization API calls                                                                                      |
| `LCM_EXPANSION_MODEL`                     | _(from OpenClaw)_                    | Model override for `lcm_expand_query` sub-agent (e.g. `openai/gpt-5.4-mini`)                                                       |
